...
<body class="sidebar-mini text-sm accent-teal">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-teal elevation-2">
            ...
            <div class="sidebar">
                ...
                <!-- <div class="user-panel text-center mt-3 mb-2 border-0">
                    <div>
                ...
                <div class="user-panel mt-3 pb-2 mb-0 d-flex">
                    <div class="image">
                        <?php $foto = CSB()->foto==null ? 'no_image.png': CSB()->foto;?>
                        <img src="<?=base_url('files/_foto/'.$foto)?>" class="img-circle elevation-1"
                            style="width:45px;height:45px;border:2px solid #f8f9fa" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block"><?=CSB()->nama_lengkap?></a>
                        <span class="badge badge-pill badge-info bg-teal"><?=CSB()->noreg?></span>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <div class="timeline mb-3">
                            <!-- timeline item -->
                            <div>
                                <i class="far fa-user bg-teal"></i>
                                <div class="timeline-item">
                                    <h3 class="timeline-header"><a href="<?=base_url('student/status')?>">Daftar
                                            Awal</a>
                                    </h3>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="timeline-item">
                                    <h3 class="timeline-header"><a href="<?=base_url('student/status')?>">Kelulusan</a>
                                    </h3>
                                </div>
                            </div>
                            <!-- END timeline item -->
                            ...
                            <!-- timeline item -->
                            <div>
                                <i class="fas fa-lock bg-teal"></i>
                                <div class="timeline-item">
                                    <h3 class="timeline-header no-border"><a
                                            href="<?=base_url('student/biodata')?>">Daftar Ulang</a></h3>
                                </div>
                            </div>
                            <!-- END timeline item -->
                            <!-- <div>
                                <i class="far fa-circle bg-light"></i>
                            </div> -->
                        </div>
        ...
        <footer class="main-footer text-sm">
            <!-- Default to the left -->
            <strong>Copyright &copy; 2023 <a href="#">PSB - MTIC</a> .</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
